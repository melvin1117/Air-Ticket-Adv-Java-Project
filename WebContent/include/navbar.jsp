            ...
            <div class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <%}
                    	...
                    	%>
                    	<li> <a href="app/admin_dashboard.jsp"><i class="glyphicon glyphicon-dashboard" style="top:3px;"></i></a>
                    	<li>
                    	<%}else
                    	{%>
                    		<li> <a href="app/user_dashboard.jsp"><i class="glyphicon glyphicon-dashboard" style="top:3px;"></i></a>
                        	<li>
                    	<%}
                    		%>
